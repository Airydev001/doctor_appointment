...
export const RelatedDoctors = ({speciality,docId}) => {
  ...
  return (
   ...
   {/* take note i suppose to set this grid template in tailwind config.css */}
   <div className='w-full grid [grid-template-columns:repeat(auto-fill,minmax(150px,1fr))] gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
